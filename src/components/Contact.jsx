...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 bg-slate-950 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-screen max-w-full overflow-x-hidden md:w-auto">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
          <a
            href={emailLink}
            className="bg-teal-500 text-white font-bold py-4 px-8 rounded-full text-lg hover:bg-teal-600 transition duration-300 flex items-center gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
